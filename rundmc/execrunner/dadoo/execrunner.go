...
func (d *ExecRunner) Run(
	...
	cmd := buildDadooCommand(
		tty, d.dadooPath, d.runMode, d.runcPath, processID, processPath, sandboxHandle, d.runcRoot,
...
func buildDadooCommand(tty bool, dadooPath, dadooRunMode, runcPath, processID, processPath, sandboxHandle, runcRoot string, extraFiles []*os.File, stdin io.Reader) *exec.Cmd {
